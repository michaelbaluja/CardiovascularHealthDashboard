...
'''layout = html.Div(
        ...
        children=html.Div(className='HeartBeat', style={'top':'118%'},children=[
                    ...
                    html.Div(className='outer',children=[
                        html.Div(className='inner'),html.Div(className="Number",id="predict_full",children=[])
                    ]
                                )),
                    dcc.Link(html.Button("Show General Stats"),href="/page2"),
