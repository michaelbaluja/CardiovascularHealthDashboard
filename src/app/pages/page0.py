...
layout = html.Div(className='HeartBeat',children=[html.P("CAN YOU PROVIDE HIGH BP, LOW BP,CHOLESTROL AND GLUCOSE LEVEL VALUES?",style={'text-align':'center','color': '#555','font-size': 'x-large'}),
