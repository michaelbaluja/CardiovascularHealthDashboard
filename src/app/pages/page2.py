...
risk_suggestions = {
    ...
    'High blood Pressure':html.Div(children=[
                                    ...
                                    html.Div(className='writings',children=[
                                                html.P(['''Among the risk factors for cardiovascular diseases (CVD), high blood pressure is the most prevalent 
                                                ...
                                                blood pressure.''']),
                                                html.P(['If you have high blood pressure you could',html.Br(),
                                                '· Reduce salt intake in your diet',html.Br(),
                                                "· Exercise regularly for atleast 20-30 minutes a day",html.Br(),
                                                "· Cut down on caffeine",html.Br(),
                                                "· Quit smoking"]),
                                                html.P(['Useful Links',html.Br(),
                                                    html.A("https://www.cdc.gov/bloodpressure/prevent.html'", 
                                                        href='https://www.cdc.gov/bloodpressure/prevent.html', target="_blank"),
                                                    html.Br(),
                                                    html.A("https://www.cdc.gov/bloodpressure/index.htm", 
                                                        href='https://www.cdc.gov/bloodpressure/index.htm', target="_blank"),
                                                    html.Br(),
                                                ]),                           
                                            ]),
                                        ]),
    'Smoking':html.Div(children=[   html.Div(dcc.Graph(figure=fig3),className='graphs'),
                                    html.Div(className='writings',children=[
                                                html.P(['''Smoking is a major cause of cardiovascular diseases (CVD) and causes approximately one of every four deaths 
                                                ...
                                                html.P(['From the data, the odds-ratio = 2.16. Smoking siginificantly increases the probability of getting a heart disease.']),
                                                html.P(['If you want to quit smoking you could - ',html.Br(),
                                                ...
                                                html.P(['Useful Links',html.Br(),
                                                    html.A("https://www.cdc.gov/tobacco/data_statistics/sgr/50th-anniversary/pdfs/fs_smoking_CVD_508.pdf", 
                                                        href='https://www.cdc.gov/tobacco/data_statistics/sgr/50th-anniversary/pdfs/fs_smoking_CVD_508.pdf', target="_blank"),
                                                    html.Br(),
                                                    html.A("https://www.cdc.gov/tobacco/quit_smoking/index.htm", 
                                                        href='https://www.cdc.gov/tobacco/quit_smoking/index.htm', target="_blank"),
                                                    html.Br(),
                                                ]), 
                                        ]),
                                ]),
    'High Cholesterol':html.Div(children=[
                                            ...
                                            html.Div(className='writings',children=[html.P(['''About 38% of American adults have high cholesterol 
                                            ...
                                            html.P(['To reduce your cholesterol you could -',html.Br(),
                                                '· Increase physical activity',html.Br(),
                                                "· Limit alcohol consumption",html.Br(),
                                                "· Consult a physician and dietician",html.Br()]),
                                                html.P(['Useful Links',html.Br(),
                                                    html.A("https://www.cdc.gov/dhdsp/data_statistics/fact_sheets/fs_state_cholesterol.htm", 
                                                        href='https://www.cdc.gov/dhdsp/data_statistics/fact_sheets/fs_state_cholesterol.htm', target="_blank"),
                                                    html.Br(),
                                                    html.A("https://www.cdc.gov/cholesterol/prevention.htm", 
                                                        href='https://www.cdc.gov/cholesterol/prevention.htm', target="_blank"),
                                                    html.Br(),
                                                ]),             
                                        ])
                            ]),
    ...
    'Inactivity':html.Div(children=[ html.Div(dcc.Graph(figure=fig6),className='graphs'),
                                        ...
                                        html.P(['If you want to increase your physical activity, you could - ',html.Br(),
                                        ...
                                        html.P(['Useful Links',html.Br(),
                                                    html.A("Link to CDC Resource", 
                                                        ...
                                                        nd%20type%202%20diabetes.''', target="_blank"),
                                                    html.Br(),
                                                    html.A("https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4626000/", 
                                                        href='https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4626000/', target="_blank"),
                                                    html.Br(),
                                                ]),
                                    ]),
    'Obesity':html.Div(children=[ html.Div(dcc.Graph(figure=fig7),className='graphs'),
                                html.Div(className='writings',children=[html.P(['The best way to treat obesity is to eat a healthy reduced-calorie diet and exercise regularly.',html.Br(),
                                    ...
                                    html.Br(),
                                    html.P(['Useful Links',html.Br(),
                                            html.A("https://www.cdc.gov/dhdsp/pubs/docs/sib_heartbeat.pdf", 
                                                href='https://www.cdc.gov/dhdsp/pubs/docs/sib_heartbeat.pdf', target="_blank"),
                                            html.Br(),
                                            html.A("https://www.cdc.gov/obesity/index.html", 
                                                href='https://www.cdc.gov/obesity/index.html', target="_blank"),
                                            html.Br(),
                                        ]),
                                    ]),
                                ])
